"""
dash_app/pages/course/print_view.py — print-ready combined HTML + Flask routes.
...
from dash_app.pages.course.content import _GUIDE_DIR, _FIG_DIR, parse_chapter_stem
