"""
dash_app/pages/market/ - Market Data page (package).
...
Public surface is unchanged: `from dash_app.pages.market import layout`.
Importing this package registers the callbacks via the callbacks import side
effect, so the app's existing `import dash_app.pages.market` keeps everything
wired. Do not remove the callbacks import.
"""
from dash_app.pages.market.layout import layout        # noqa: F401  (public API)
from dash_app.pages.market import callbacks            # noqa: F401  (registers callbacks)
