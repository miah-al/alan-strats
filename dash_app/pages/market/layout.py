"""
dash_app/pages/market/layout.py - the Market Data page view.
...
design system (dash_app.ui) for the page header; every component id is identical
...
from dash_app.pages.market.data import (
...
from dash_app.pages.market.guides import (
