"""
dash_app/pages/paper_trading/ — Paper Trading page (package).
...
Public surface is unchanged: `from dash_app.pages.paper_trading import layout`.
Importing this package registers the callbacks via side effect, so the app's
existing `import dash_app.pages.paper_trading` keeps everything wired.
"""
from dash_app.pages.paper_trading.layout import layout        # noqa: F401  (public API)
from dash_app.pages.paper_trading import callbacks            # noqa: F401  (registers callbacks)
