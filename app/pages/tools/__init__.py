"""
app/pages/tools/ -- Tools & Data Management hub (package).
...
Public surface is unchanged: `from app.pages.tools import layout`.
Importing this package registers the callbacks via the callbacks import below.
"""
from app.pages.tools.layout import layout      # noqa: F401  (public API)
from app.pages.tools import callbacks          # noqa: F401  (registers callbacks)
