"""
app/pages/tools/tabs.py -- per-tab layout builders + _get_tab_builder.
...
(app.pages.models / app.pages.course).

Adopts the shared design system (app.ui) tokens; all component ids are
...
def _models_tab() -> html.Div:
    from app.pages.models import layout as _models_layout
    return html.Div(_models_layout(), style={"padding": "16px 0"})


def _course_tab() -> html.Div:
    from app.pages.course import layout as _course_layout
