"""
app/pages/models - Models workbench (package).
...
Public surface unchanged: `from app.pages.models import layout`.
Importing the package imports callbacks for its registration side-effect.
"""
from app.pages.models.layout import layout      # noqa: F401  (public API)
from app.pages.models import callbacks          # noqa: F401  (registers callbacks)
