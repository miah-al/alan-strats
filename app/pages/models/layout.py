# -*- coding: utf-8 -*-
"""
app/pages/models - layout (tab builders + top-level layout()).

Builds every Options/Rates sub-tab and assembles the page. Adopts the shared
design system (app.ui) for the page header + page surface; the dense,
strategy-specific tiles/sliders come from app.pages.models.pricing.
...
from app.pages.models.pricing import _title, _tile, _slider
